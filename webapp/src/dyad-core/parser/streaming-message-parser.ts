 ...
 *   src/lib/streamingMessageParser.ts
 * Only the relative import path was adjusted. This is the incremental
 * dyad-tag parser that powers streaming chat rendering.
 */
